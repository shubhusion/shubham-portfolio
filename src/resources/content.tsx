...
const home: Home = {
  ...
  label: "Home",
  title: "Software Engineer building scalable backend and AI systems",
  headline: "Welcome to my portfolio!",
  subline: "Explore my work, blog, and more.",
  featured: { display: false, title: "", href: "" },
  description:
    "I design and ship production-grade software with a focus on backend systems, RAG-based AI applications, and reliable web platforms.",
};
